...
parser <- ArgumentParser(description='online_iNMF for the integrative analysis of multi-batch single-cell transcriptomic profiles')
...
print(Batch_size)
adata = online_iNMF(adata, k = 20, miniBatch_size = Batch_size, max.epochs = 5)
